...
describe('Calculating shipping with invalid length', () => {
  ...
  it('Insert dimensions', () => {
    ...
    cy.get(loc.DIMENSIONS.LENGTH).type(info.INVALID_PACKAGE_DIMENSIONS.LENGTH)
  });
  ...
  it('Validating', () => {
    cy.get(loc.VALIDATIONS.INVALID_LENGTH).should("be.visible")
    cy.screenshot()
  });
})
