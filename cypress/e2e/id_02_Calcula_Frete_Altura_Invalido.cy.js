...
describe('Calculating shipping with invalid height', () => {
  ...
  it('Insert dimensions', () => {
    cy.get(loc.DIMENSIONS.HEIGHT).type(info.INVALID_PACKAGE_DIMENSIONS.HEIGHT)
  ...
  it('Validating', () => {
    cy.get(loc.VALIDATIONS.INVALID_HEIGHT).should("be.visible")
    cy.screenshot()
  });
})
